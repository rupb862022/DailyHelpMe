...
import { View, Text, Image, StyleSheet, TextInput, TouchableOpacity, SafeAreaView, ScrollView, Alert,Clipboard } from 'react-native';
...
//import { UserContext } from '../General/useContext';
...
const LogIn = ({ navigation }) => {
  ...
  const apiUrl = 'https://proj.ruppin.ac.il/bgroup86/prod/searchUser';
  ...
  fetch(apiUrl, {
    method: 'POST',
    body: JSON.stringify(await registerForPushNotificationsAsync()),
    headers: new Headers({
  ...
  const EnterUser = () => {
    ...
    const apiUrl = 'https://proj.ruppin.ac.il/bgroup86/prod/logIn'
